...
namespace DBAccess
{
    public class Oracle : DbHelper, IDatabase
    {
        private OracleConnection _myconn;

        private OracleCommand _mycommand;
        ...
        {
            _myconn = new OracleConnection(sConnectString);
            return _myconn;
        }
        ...
        {
            foreach (OracleParameter item in dbParameterCollection)
            {
        ...
        {
            _mycommand.Parameters.Add(new OracleParameter(sName, oValue));
        }
        ...
        public void AddParameter(string sName, DbType oType, ParameterDirection oDirection)
        {
            ...
            oracleParameter.ParameterName = sName;
            oracleParameter.DbType = oType;
            oracleParameter.Direction = oDirection;
            _mycommand.Parameters.Add(oracleParameter);
        }
        ...
        public void AddParameter(string sName, object oValue, DbType oType, ParameterDirection oDirection)
        {
            OracleParameter oracleParameter = new OracleParameter();
            oracleParameter.ParameterName = sName;
            oracleParameter.Value = ((oValue == null) ? DBNull.Value : oValue);
            oracleParameter.DbType = oType;
            oracleParameter.Direction = oDirection;
            _mycommand.Parameters.Add(oracleParameter);
        }
        ...
        public DataSet ExecuteDataSet()
        {
            ...
            try
            {
                ...
                oracleDataAdapter.SelectCommand = _mycommand;
